...
_ENGINEERING_PERMISSION_SEEDS = [
    ...
    {
        "name": "工艺路线删除",
        "code": "ENGINEERING_PROCESS_ROUTES_DELETE",
        "resource": "/engineering/process-routes",
        "action": "delete",
        "description": "删除工艺路线",
        "parent_code": "ENGINEERING_PROCESS_ROUTES_READ",
...
_RESOURCE_CATEGORY_SEEDS = [
    ...
    {"name": "机加工", "code": "PROCESS_MACHINING", "resource_type": "PROCESS", "parent_code": None, "sort_order": 4, "description": "车削、铣削、钻孔、磨削等切削加工工艺"},
    {"name": "连接与装配", "code": "PROCESS_JOINING_ASSEMBLY", "resource_type": "PROCESS", "parent_code": None, "sort_order": 5, "description": "焊接与装配类工艺"},
    {"name": "热处理", "code": "PROCESS_HEAT_TREATMENT", "resource_type": "PROCESS", "parent_code": None, "sort_order": 6, "description": "热处理类工艺"},
    {"name": "表面处理", "code": "PROCESS_SURFACE_TREATMENT", "resource_type": "PROCESS", "parent_code": None, "sort_order": 7, "description": "表面处理类工艺"},
