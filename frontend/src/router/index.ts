  ...
  },
  {
    ...
    children: [
      // ── 模块一：全景视界 ──────────────────────────────
      {
        ...
        meta: { title: '首页', module: 'dashboard' },
      },
        ...
        children: [
          {
            ...
            meta: { title: '基础字典与模板', requiredPermissionScope: '/master-data/dict-templates:read' },
          },
          {
            path: 'materials',
            name: 'Materials',
      ...
      // ── 模块三：工程建模与协同 ────────────────────────
      {
        ...
        meta: { title: '工程建模中心', module: 'engineering' },
        children: [
          {
            path: 'projects',
            name: 'Projects',
            component: () => import('@/views/engineering/ProjectsView.vue'),
            meta: { title: '产品方案池', requiredPermissionScope: '/engineering/projects:read' },
          },
          {
            path: 'cost-ledger/:snapshotId',
            name: 'EngineeringCostLedger',
          ...
          },
          {
            ...
            meta: { title: '设计要素编排', requiredPermissionScope: '/engineering/bom-nodes:read' },
          },
          {
            path: 'lcc-compare',
            name: 'LccCompare',
            component: () => import('@/views/engineering/LccCompareView.vue'),
            meta: { title: 'LCC 多方案对比', requiredPermissionScope: '/engineering/snapshots:read' },
          },
        ],
      },
      ...
      // ── 模块四：成本核算 ─────────────────────────────
      {
        ...
        name: 'Costing',
        component: () => import('@/layouts/RouteSectionView.vue'),
        redirect: '/costing/lcc-financial-baselines',
        meta: { title: '成本仿真与决策', module: 'costing' },
        children: [
          {
            path: 'lcc-financial-baselines',
            name: 'LccFinancialBaselines',
            component: () => import('@/views/engineering/LccFinancialBaselineView.vue'),
            meta: { title: 'LCC财务评估标准', requiredPermissionScope: '/costing/lcc-financial-baselines:read' },
          },
          {
          ...
          {
            path: 'lcc-report/:snapshotId',
            name: 'LccReport',
            component: () => import('@/views/engineering/LccReportView.vue'),
            meta: { title: 'LCC 对标分析报告', requiredPermissionScope: '/engineering/snapshots:read' },
          },
        ],
      },
